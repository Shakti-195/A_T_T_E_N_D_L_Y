...
#     app.config['MAIL_USERNAME'] = os.environ.get('MAIL_USERNAME', '9a8252001@smtp-brevo.com')
#     app.config['MAIL_PASSWORD'] = os.environ.get('BREVO_API_KEY')  # ✅ FIXED LINE
#     app.config['MAIL_DEFAULT_SENDER'] = os.environ.get(
#        'MAIL_DEFAULT_SENDER', 
#        'Attendly <thakurshaktisingh195@10125906.brevosend.com>'
#    )
